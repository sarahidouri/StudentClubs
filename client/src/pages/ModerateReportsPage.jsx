...
export const ModerateReportsPage = () => (
  <div className="min-h-screen bg-light py-12">
    <div className="container-custom">
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-bold mb-2">Moderate Reports</h1>
        <p className="text-gray-600">
          Report moderation tools will appear here when the reports API is ready.
        </p>
      </div>
